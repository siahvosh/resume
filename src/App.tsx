...
function App() {
    ...
    const [stepperDetail] = useState([
        {title: 'Simple', description: 'Animate every transform axis independently, without needing multiple elements.', image: `${img}`},
        {title: 'BI Dashboard', description: 'Lorem ipsum dolor sit amet.', image: `${img2}`},
        {title: 'React library', description: 'Lorem ipsum dolor sit amet.', image: `${img3}`},
        {title: 'More', description: 'Lorem ipsum dolor sit amet.', image: `${img4}`},
    ]);
        ...
        <div className="template">
            ...
            <div className={'cont-2'} ref={cont2Ref}>
                <Grid2 container spacing={10} className={'scroll-box'}>
                    ...
                    <Grid2 size={{xs: 12, sm: 12, md: 12, lg: 6}} className={'text-container'}>
                        <div className="images-box" style={{position: "relative", height: "300px"}}>
                            <AnimatePresence>
                                {stepperDetail.slice(0, activeIndex + 1).map((item, index) => (
                                    <motion.img
                                        ...
                                        initial={{opacity: 0, scale: 1, rotate: 15, skewX: -33, skew: -5, translateX: -200}}
                                        animate={{
                                            opacity: index === activeIndex ? 1 : 0.5, // عکس فعال ۱، قبلی‌ها کم‌رنگ
                                            scale: 1,
                                            rotate: 15, // چرخش کمتر برای زیبایی
                                            skewX: -33, // کاهش افکت برای طبیعی‌تر شدن
                                            translateX: 0,
                                            skew: -10
                                        ...
                                        exit={{opacity: 0, scale: 1, rotate: 15, skewX: -40, skew: -5, translateX: -200}}
...
//             <Grid2 size={12} style={{border: '2px solid blue', width: '100%'}}>
//                 <article id="gallery">
...
//
//                     {/*        <svg width="100vw" fill viewBox="0 0 5120 337"*/}
