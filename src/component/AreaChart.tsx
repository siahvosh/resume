...
//
// const StockChart: React.FC<StockChartProps & WithTooltipProvidedProps<TooltipData>> =
//     ({
//          width,
//         height,
...
//             {tooltipData && (
//                 <div>
//                     <TooltipWithBounds key={Math.random()} top={tooltipTop - 10} left={tooltipLeft + 12} style={tooltipStyles}>
...
// };
//
// export default withTooltip<StockChartProps, TooltipData>(StockChart);
