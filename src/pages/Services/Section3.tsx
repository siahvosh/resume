...
export const Section3 = () => {
    return(
        <div>
            <TopCard title={'Section 3'} description={'Section 3'} image={'https://img.freepik.com/free-photo/flat-lay-black-background-with-laptop-coffee-cup-calculator-top-view_169016-34849.jpg?t=st=1740598060~exp=1740601660~hmac=540e0993e14a0cacbac928004698bbf33d9a668529794012f02d781c60508964&w=1380'}/>
            <div className={'about-body'}>
                <span className={'body-title'}>Section 3</span>
